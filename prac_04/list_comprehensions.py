...
# list comprehension of a list of all the full_names in lowercase format
...
# list comprehension of only a list of numbers that are greater than 9
...
# list comprehension and the join string method that creates a string (not list) of the last names for those full
# names longer than 11 characters
name_records = [word.split() for word in full_names]
print(name_records)
